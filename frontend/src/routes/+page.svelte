<script lang="ts">
  ...
  let currentlyReading = $derived(booksState.all.filter((b) => b.progress?.status === 'reading'));
  ...
  <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
    <div class="flex flex-col gap-1 rounded-lg border bg-card p-4 shadow-sm">
      <div class="flex items-center gap-2 text-muted-foreground">
        ...
        <span class="text-xs font-medium tracking-wide uppercase">Books</span>
      </div>
    ...
    <div class="flex flex-col gap-1 rounded-lg border bg-card p-4 shadow-sm">
      <div class="flex items-center gap-2 text-muted-foreground">
        ...
        <span class="text-xs font-medium tracking-wide uppercase">Libraries</span>
      </div>
    ...
    <div class="flex flex-col gap-1 rounded-lg border bg-card p-4 shadow-sm">
      <div class="flex items-center gap-2 text-muted-foreground">
        ...
        <span class="text-xs font-medium tracking-wide uppercase">Authors</span>
      </div>
    ...
    <div class="flex flex-col gap-1 rounded-lg border bg-card p-4 shadow-sm">
      <div class="flex items-center gap-2 text-muted-foreground">
        ...
        <span class="text-xs font-medium tracking-wide uppercase">Reading</span>
      </div>
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-1 text-sm text-muted-foreground/70">
          <a href="/settings" class="text-primary hover:underline">Add a library</a> or drop books
          in
