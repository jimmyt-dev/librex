      ...
      {#if loading}
        ...
        {#each Array(8) as _, i (i)}
          <tr class="border-b last:border-0">
            ...
            <td class="px-4 py-2"><Skeleton class="h-4 w-1/2" /></td>
            <td class="px-4 py-2"><Skeleton class="h-4 w-2/3" /></td>
            <td class="px-4 py-2"><Skeleton class="h-4 w-1/4" /></td>
            <td class="px-4 py-2"><Skeleton class="h-3 w-8" /></td>
